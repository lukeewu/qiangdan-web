<?php /*a:2:{s:58:"/www/wwwroot/qiangdan/application/index/view/my/index.html";i:1641820478;s:62:"/www/wwwroot/qiangdan/application/index/view/public/floor.html";i:1640708654;}*/ ?>
...
<!DOCTYPE html><!-- saved from url=(0035)http://qiang6-www.baomiche.com/#/My --><html data-dpr="1" style="font-size: 37.5px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="viewport" content="width=device-width,user-scalable=no,initial-scale=1,maximum-scale=1,minimum-scale=1"><title>my</title><link href="/static_new6/css/app.7b22fa66c2af28f12bf32977d4b82694.css" rel="stylesheet"><link rel="stylesheet" href="/static_new/css/public.css"><script charset="utf-8" src="/static_new/js/jquery.min.js"></script><script charset="utf-8" src="/static_new/js/dialog.min.js"></script><script charset="utf-8" src="/static_new/js/common.js"></script><style type="text/css" title="fading circle style">        .circle-color-8 > div::before {
        ...
        .login_nav li a{
        ...
        </style><div data-v-8755e8fe="" data-v-eebac136="" class="footer"  style="background: none;width: 100%;height: 1.7rem;background-color: white;"><ul data-v-8755e8fe=""><li style="display: block;margin: 0 2%;" onclick="window.location.href='<?php echo url('index/home'); ?>'" data-v-8755e8fe=""><?php
            ...
            $level = $level + 1;
            $url = '/index/ctrl/team';
        ?><li style="display: block;margin: 0 2%;" onclick="window.location.href='<?=$url?>'" data-v-8755e8fe=""><?php
                if(cookie('lang') == 'th-th' ){
            ?><img data-v-8755e8fe=""
            ...
            ?><!--<img data-v-8755e8fe=""--><!--     src="<?php echo lang('img_bar_h1'); ?>"--><!--     alt="" style="border-radius:30px;">--><!--<img data-v-8755e8fe=""--><!--     src="<?php echo lang('img_bar_h1'); ?>"--><!--     alt=""  style="border-radius:30px;">--></li><li style="display: block;margin: 0 2%;" onclick="window.location.href='<?php echo url('my/index'); ?>'" data-v-8755e8fe=""><?php
                if(cookie('lang') == 'th-th' ){
            ?><img data-v-8755e8fe=""
                 src="/image/9681.png"
                 alt="" style="margin-top: -0.3rem;"><img data-v-8755e8fe=""
