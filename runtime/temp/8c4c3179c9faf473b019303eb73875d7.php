...
<!DOCTYPE html><!-- saved from url=(0041)http://qiang6-www.baomiche.com/#/Recharge --><html data-dpr="1" style="font-size: 37.5px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="viewport" content="width=device-width,user-scalable=no,initial-scale=1,maximum-scale=1,minimum-scale=1"><title><?php echo htmlentities(app('lang')->get('Recharge')); ?></title><link href="/static_new6/css/app.7b22fa66c2af28f12bf32977d4b82694.css" rel="stylesheet"><script charset="utf-8" src="/static_new/js/jquery.min.js"></script><script charset="utf-8" src="/static_new/js/dialog.min.js"></script><script charset="utf-8" src="/static_new/js/common.js"></script><link rel="stylesheet" href="/static_new/css/public.css"><style type="text/css" title="fading circle style">        .circle-color-8 > div::before {
            background-color: #ccc;
                    ...
                    alt="" class="return"></div><div class="Maintitle"><h3><?php echo htmlentities(app('lang')->get('Recharge')); ?></h3></div><div class="right_btn"><a data-v-7d87b156="" href="http://qiang6-www.baomiche.com/#/RechargeRecord" class=""><h3 data-v-7d87b156=""><?php echo htmlentities(app('lang')->get('Rechargerecord')); ?></h3></a></div></div><div data-v-7d87b156="" class="Cash_num main2"><h3 data-v-7d87b156=""><?php echo htmlentities(app('lang')->get('Rechargeamount')); ?></h3><div data-v-7d87b156="" class="Cash_num_money"><span data-v-7d87b156=""><?php echo lang('￥'); ?></span><input data-v-7d87b156="" name="price" type="text" placeholder="<?php echo htmlentities(app('lang')->get('Enteramount')); ?>"></div><h4 data-v-7d87b156="" style="color:red"><?php echo lang('the recharge amount can be entered manually, with a minimum recharge of 300'); ?></h4><div data-v-7d87b156="" class="Cash_num_password"><span data-v-7d87b156="" class="col-xs-3" style="color:#d91d37">300<?php echo htmlentities(app('lang')->get('yuan')); ?></span><span data-v-7d87b156="" class="col-xs-3" style="color:#d91d37">500<?php echo htmlentities(app('lang')->get('yuan')); ?></span><span data-v-7d87b156="" class="col-xs-3" style="color:#d91d37">1000<?php echo htmlentities(app('lang')->get('yuan')); ?></span><span data-v-7d87b156="" class="col-xs-3" style="color:#d91d37">3000<?php echo htmlentities(app('lang')->get('yuan')); ?></span></div></div><button data-v-7d87b156=""  id='submits'><?php echo htmlentities(app('lang')->get('Nextstep')); ?></button><div data-v-7d87b156="" class="Cash_num paytype" style="display: none ;"><h3 data-v-7d87b156=""><?php echo htmlentities(app('lang')->get('Pleaseselectpaymentchannel')); ?></h3><ul data-v-7d87b156="" class="open_Lottery_ul"><?php foreach($pay as $key=>$vo): ?><!--                <li data-v-7d87b156="" onclick="window.location.href=`/index/support/index`">--><!--                    <img data-v-7d87b156="" src="/static_new6/img/unionpay.jpg" alt="">--><!--                    <div data-v-7d87b156="" class="open_Lottery_ul_con">--><!--                        <h3 data-v-7d87b156="">--><!--                            充值请咨询在线客服--><!--                            <span data-v-7d87b156="" style="display: none;">推荐</span>--><!--                        </h3>--><!--                        <h4 data-v-7d87b156="">充值请联系客服&nbsp;</h4>--><!--                    </div>--><!--                </li>--><li data-v-7d87b156="" class="save-btn2" data-id="<?php echo htmlentities($vo['name2']); ?>"><img data-v-7d87b156="" src="<?php echo htmlentities($vo['ico']); ?>" onerror="this.src='/static_new6/img/unionpay.jpg'" alt=""><div data-v-7d87b156="" class="open_Lottery_ul_con"><h3 data-v-7d87b156=""><?php echo lang($vo['name']); ?><span data-v-7d87b156="" style="display: block;display: block;
    background: red;
    padding: 1px 4px;
    color: #fff;
    border-radius: 3px;"><?php echo lang('推荐'); ?></span><h4 data-v-7d87b156=""><?php echo lang($vo['name']); ?>&nbsp;</h4></h3></div></li><?php endforeach; ?></ul></div><div style="display:none" id="chong"></div></div></div><script type="application/javascript">    var type = '';
    $(function () {
        function check() {
            if ($("input[name=price]").val() == '') {
                $(document).dialog({infoText: '<?php echo htmlentities(app('lang')->get('Enteramount')); ?>'});
                return false;
            }
            return true;
        }
        ...
        $('.Cash_num_password span').click(function () {
            var tt = $(this).text();
            tt = tt.replace('<?php echo htmlentities(app('lang')->get('yuan')); ?>','');
        ...
        $('#submits').click(function () {
            ...
            // if (type == '') {
            //     $(document).dialog({infoText: '<?php echo htmlentities(app('lang')->get('SelectPaymentMethod')); ?>'});
            //     return false;
            // }
 $('.paytype').show();
              $('.main2').hide()
...
type = $(this).data('id');
            ...
            window.location.href="/index/ctrl/recharge2?type="+type+"&num="+price;
