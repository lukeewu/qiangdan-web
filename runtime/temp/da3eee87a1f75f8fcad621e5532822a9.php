...
<!DOCTYPE html><html data-dpr="1" style="font-size: 37.5px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="viewport" content="width=device-width,user-scalable=no,initial-scale=1,maximum-scale=1,minimum-scale=1"><title><?php echo htmlentities(app('lang')->get('Deliveryaddressmanagement')); ?></title><link href="/static_new6/css/app.7b22fa66c2af28f12bf32977d4b82694.css" rel="stylesheet"><link rel="stylesheet" href="/static_new/css/public.css"><script charset="utf-8" src="/static_new/js/jquery.min.js"></script><script charset="utf-8" src="/static_new/js/dialog.min.js"></script><script charset="utf-8" src="/static_new/js/common.js"></script><style type="text/css" title="fading circle style">        .circle-color-8 > div::before {
        ...
        .save-btn {
            background-color: #255cbd !important;
                    ...
                    alt="" class="return"></div><div class="Maintitle"><h3><?php echo htmlentities(app('lang')->get('Deliveryaddressmanagement')); ?></h3></div><div class="right_btn"></div></div><div data-v-8831f782="" class="bink_card"><h3 data-v-8831f782=""><?php echo htmlentities(app('lang')->get('deliveryinformation')); ?></h3><ul data-v-8831f782="" class="bink_card_ul"><li data-v-8831f782=""><h4 data-v-8831f782=""><?php echo htmlentities(app('lang')->get('actualname')); ?></h4><input data-v-8831f782="" type="text" name="shoujianren" value="<?php echo htmlentities($info['name']); ?>" placeholder="<?php echo htmlentities(app('lang')->get('Nonameenteredpleaseset')); ?>"></li><li data-v-8831f782=""><h4 data-v-8831f782=""><?php echo htmlentities(app('lang')->get('number_tel')); ?></h4><input data-v-8831f782="" type="text" name="shouhuohaoma_bak" class="J_tel_bak" value="<?php echo htmlentities($tel_bak); ?>" placeholder="<?php echo htmlentities(app('lang')->get('Nophonenumberenteredpleaseset')); ?>"><input data-v-8831f782="" type="hidden" name="shouhuohaoma" class="J_tel" value="<?php echo htmlentities($info['tel']); ?>"><!--</li></ul><h3 data-v-8831f782="">收货地址信息</h3><ul data-v-8831f782="" class="bink_card_ul"><li data-v-8831f782=""><h4 data-v-8831f782="">地区</h4><input data-v-8831f782="" type="text" name="area" autocomplete="off" value="<?php echo htmlentities($info['area']); ?>" placeholder="未输入地区，请设置"></li>--><li data-v-8831f782=""><h4 data-v-8831f782=""><?php echo htmlentities(app('lang')->get('Address')); ?></h4><input data-v-8831f782="" name="address" autocomplete="off" value="<?php echo htmlentities($info['address']); ?>" type="text" placeholder="<?php echo htmlentities(app('lang')->get('Nodetailedaddressenteredpleaseset')); ?>"></li></ul><h3 data-v-8831f782="">&nbsp;</h3><ul data-v-8831f782="" class="bink_card_ul"><li data-v-8831f782=""><h4 data-v-8831f782=""><?php echo htmlentities(app('lang')->get('Setasommonaddress')); ?></h4><label data-v-8831f782="" class="mint-switch"><input type="checkbox" class="mint-switch-input" checked readonly disabled><span class="mint-switch-core"></span><div class="mint-switch-label"></div></label></li></ul></div><p data-v-8831f782="" class="save-btn test"><?php echo htmlentities(app('lang')->get('determine')); ?></p></div></form></div><script type="application/javascript">    $(function () {
        /*点击登录*/
        $(".save-btn").on('click', function (eachCallback) {
            ...
            // if (!reg.test($("input[name=shouhuohaoma]").val())) {
            ...
            $.ajax({
                ...
                beforeSend: function () {
                    loading = $(document).dialog({
                        ...
                        infoText: '<?php echo htmlentities(app('lang')->get('Deliveryaddressmanagement')); ?>',
                        autoClose: 0
                    });
                },
                success: function (data) {
                    ...
                    if (data.code == 0) {
                        $(document).dialog({infoText: '<?php echo htmlentities(app('lang')->get('z_Loading')); ?>'});
                        setTimeout(function () {
